...
-file("c:/Users/gp69e5en/Documents/Gratuiciels/erl10.3/lib/parsetools-2.1.8/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
yeccpars2_5(S, dp, Ss, Stack, T, Ts, Tzr) ->
 yeccpars1(S, 6, Ss, Stack, T, Ts, Tzr);
yeccpars2_5(_, _, _, _, T, _, _) ->
 yeccerror(T).

-dialyzer({nowarn_function, yeccpars2_6/7}).
yeccpars2_6(S, operation, Ss, Stack, T, Ts, Tzr) ->
 yeccpars1(S, 9, Ss, Stack, T, Ts, Tzr);
yeccpars2_6(_, _, _, _, T, _, _) ->
 yeccerror(T).

-dialyzer({nowarn_function, yeccpars2_7/7}).
yeccpars2_7(S, be, Ss, Stack, T, Ts, Tzr) ->
 yeccpars1(S, 16, Ss, Stack, T, Ts, Tzr);
yeccpars2_7(_, _, _, _, T, _, _) ->
 yeccerror(T).

yeccpars2_8(S, operation, Ss, Stack, T, Ts, Tzr) ->
 yeccpars1(S, 9, Ss, Stack, T, Ts, Tzr);
yeccpars2_8(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 NewStack = yeccpars2_8_(Stack),
 yeccgoto_instructions(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).

yeccpars2_9(S, data_type, Ss, Stack, T, Ts, Tzr) ->
...
yeccpars2_12(S, point, Ss, Stack, T, Ts, Tzr) ->
...
yeccgoto_address(10=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_11(_S, Cat, Ss, Stack, T, Ts, Tzr).
...
-file("src/s5_stl_parser.yrl", 43).
yeccpars2_9_(__Stack0) ->
 [__1 | __Stack] = __Stack0,
 [begin
   { extract_token ( uw_atom ( __1 ) ) , no_operand , [ ] }
  end | __Stack].

-compile({inline,yeccpars2_11_/1}).
-file("src/s5_stl_parser.yrl", 37).
...
-file("src/s5_stl_parser.yrl", 25).
yeccpars2_16_(__Stack0) ->
 [__5,__4,__3,__2,__1 | __Stack] = __Stack0,
 [begin
   {
    extract_token ( uw_atom ( __1 ) ) ,
    extract_token ( uw_int ( __2 ) ) ,
    lists : append ( [ __4 , [ { list_to_atom ( "BE" ) , no_operand , [ ] } ] ] )
    }
  end | __Stack].

-compile({inline,yeccpars2_17_/1}).
-file("src/s5_stl_parser.yrl", 23).
